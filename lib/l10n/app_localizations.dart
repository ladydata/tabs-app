...
abstract class AppLocalizations {
  ...
  /// No description provided for @splitExpensesWithEase.
  ///
  /// In en, this message translates to:
  /// **'Split expenses with ease'**
  String get splitExpensesWithEase;
  ...
  /// No description provided for @equally.
  ///
  /// In en, this message translates to:
  /// **'Equally'**
  String get equally;
  ...
  /// No description provided for @joinTabs.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @unequally.
  ///
  /// In en, this message translates to:
  /// **'unequally'**
  String get unequally;
